...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.teamAMain"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.teamASecondary"; //class given by name; is supposed to extends robotsimulator.Brain
