...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.FifthElementMain"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.FifthElementSecondary"; //class given by name; is supposed to extends robotsimulator.Brain
  public static final String teamASecondaryBotAvatar = "avatars/clumpsy.png";
