...
public class Parameters {
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.Main"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.Secondary"; //class given by name; is supposed to extends robotsimulator.Brain
